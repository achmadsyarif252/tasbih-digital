...
const DOA_HARIAN = [
  {
    ...
    "arab":
        "الْحَمْدُ لِلّٰهِ الّذِي أَحْيَانَا بَعْدَ مَا أَمَاتَنَا وَإِلَيْهِ النُّشُوْرِ",
    "latin":
        "Alhamdulillahilladzi ahyaana ba'da maa amaatanaa wa ilaihinnusyuur",
    "arti":
  ...
  },
  {
    ...
    "arab":
        "لَا إِلَهَ إِلَّا اللهُ وَحْدَهُ لَا شَرِيْكَ لَهُ. لَهُ الْمُلْكُ وَلَهُ الْحَمْدُ وَهُوَ عَلَى كُلِّ شَيْءٍ قَدِيْرٌ. سُبْحَانَ اللّٰهِ وَالْحَمْدُ لِلّٰهِ وَلَا إِلَهَ إِلَّا اللّٰهُ وَاللّٰهُ أَكْبَرُ، وَلَا حَوْلَ وَلَا قُوَّةَ إِلَّا بِاللّٰهِ الْعَلِيِّ الْعَظِيْمِرَبِّ اغْفِرْليِ",
    "latin":
        "Laa ilaha illallohu wahdahuu laa syariikalahu. Lahulmulku wa lahulhamdu wahuwa 'alaa kulli syai'in qadiir. Subhaanallahi walhamdulillahi walaa ilaha illallohu wallohu akbaru. Wa laahaula wa laaquwata illabillahil 'aliyil 'adziimirrobbighfirlii",
    "arti":
        "Tiada Tuhan selain Allah, Yang Maha Esa, tiada sekutu bagi-Nya. Bagi-Nya kerajaan dan bagi-Nya pujian. Dia-lah Yang Maha Kuasa atas segala sesuatu. Maha Suci Allah, segala puji bagi Allah, tiada Tuhan selain Allah, Allah Maha Besar. Tiada upaya dan kekuatan kecuali dengan pertolongan Allah Yang Maha Tinggi dan Maha Agung. Ya Tuhanku, ampunilah dosaku",
    "footnote":
  ...
  },
  {
    ...
    "arab":
        "اَلْحَمْدُ لِلّٰهِ الَّذِي عَافَانِي فِي جَسَدِي وَرَدَّ عَلَيَّ رُوْحِيْ وَأَذِنَ لِيْ بِذِكْرِهِ",
    "latin":
        "Alhamdulillahilladzi 'aafaani fii jasadi warodda ilaiya ruuhi wa adzinaa lii bidzikrihi",
    "arti":
  ...
  },
  {
    ...
    "footnote":
        "Ayat dari surat Ali Imran: 190-200, shahih Bukhari dalam Fathul Bari 8/237, Muslim 1/530"
  },
  {
    "tag": ['rumah', 'pakaian', 'setiap hari'],
    "judul": "Do'a Mengenakan Pakaian",
    "arab":
        "اَلْحَمْدُ لِلّٰهِ الَّذِي كَسَانِيْ هَذَا (الثَّوْبَ) وَرَزَقَنِيْهِ مِنْ غَيْرِ حَوْلٍ مِنِّيْ وَلَا قُوَّةٍ",
    "latin":
        "Alhamdulillahilladzi kasaanii hadzaatssauba warozaqoniihi min ghairi khaulin minnii walaa quwwatin",
    "arti":
    ...
    "footnote":
        "Hadits diriwayatkan oleh semua penyusun kitab sunan, kecuali Nasa'i, lihat: Irwa'ul ghalil"
  },
  {
    "tag": ['rumah', 'pakaian'],
    "judul": "Do'a Mengenakan Pakaian Baru",
    "arab":
        "اللَّهُمَّ لَكَ الْحَمْدُ أَنْتَ كَسَوْتَنِيْهِ، أَسْأَلُكَ مِنْ خَيْرِهِ وَخَيْرِ مَا صُنعَ لَهُ، وَأَعُوْذُ بِكَ مِنْ شَرِّهِ وَشَرِّ مَا صُنعَ لَهُ",
    "latin":
        "Allohumma lakalhamdu anta kasautaniihi, as'aluka min khoirihi wa khoiri maa shun'a lahu, wa a'uudzubika min syarrihi wasyarrima shun'a lahu",
    "arti":
        "Ya Allah hanya miliki-Mu segala puji, Engkaulah yang memberi pakaian ini kepadaku. Aku mohon kepada-Mu untuk memperoleh kebaikannya dan kebaikan yang ia diciptakan karenanya. Aku berlindung kepada-Mu dari kejahatannya dan kejahatan yang ia diciptakan karenanya",
    "footnote":
        "HT. Abu Dawud, At-Tirmidzi, Al-Baghawi dan lihat Mukhtashar Syamaailit Tirmidzi, oleh Al-Albani, hal: 47"
  },
  {
    "tag": ['rumah', 'pakaian'],
  ...
  },
  {
    ...
    "footnote":
        "HR. At-Tirmidzi: 2/505 dan Imam yang lain. Lihat Irwa'ul Ghalil, 49 dan Shahihul Jami': 3/230"
  },
  {
    "tag": ['rumah', 'toilet', 'wc'],
    "judul": "Doa Masuk Toilet",
    "arab":
        "(بِسْمِ اللّٰهِ) اَللَّهُمَّ إِنِّيْ أَعُوْذُ بِكَ مِنَ الْخُبُثِ وَالْخَبائِثْ",
    "latin":
        "(Bismillahi) Allohumma inni a'udzubika minal khubutsi wal khobaits",
    "arti":
  ...
  },
  {
    ...
    "footnote":
        "Hadist diriwayatkan oleh para penulis kutubus sunan kecuali Imam Nasa'i, beliau meriwayatkan di kitab amalul yaumi wa lailah, lihat juga takhrij zadil maad 2/122"
  },
  {
  ...
  },
  {
    ...
    "arab":
        "أَشْهَدُ أَنْ لَا إِلَهَ إِلَّا اللّٰهُ وَحْدَهُ لَا شَرِيْكَ لَهُ وَأَشْهَدُ أَنَّ مُهَمَّدًا عَبْدُهُ وَرَسُوْلُهُ",
    "latin":
        "Asyhadu allailaha illalloh wa asyhadu anna muhammadan abduhu warosuluhu",
    "arti":
  ...
  },
  {
    ...
    "judul": "Bacaan Setelah Wudhu",
    "arab":
        "اَللَّهُمَّ اجْعَلْنِيْ مِنَ التَّوَّابِيْنَ وَاجْعَلْنِيْ مِنَ الُمُتَطَهِّرِيْنَ",
  ...
  },
  {
    ...
    "judul": "Bacaan Setelah Wudhu",
    "arab":
        "سُبْحَانَكَ اللَّهُمَّ وَبِحَمْدِكَ، أَشْهَدُ أَنْ لَا إِلَهَ إِلَّا أَنْتَ، أَسْتَغْفِرُكَ وَأَتُوْبُ إِلَيْكَ",
    "latin":
        "Subhanakallohumma wabihamdika asyhadu anlaailaha illa anta astaghfiruka wa'atubu ilaik",
    "arti":
  ...
  },
  {
    ...
    "arab":
        "بِسْمِ اللَّهِ، تَوَكَّلتُ عَلَى اللّٰهِ،  وَلَا حَوْلَ وَلَا قُوَّةَ إِلَّا بِاللّٰهِ",
    "latin":
        "Bismillahi tawakkaltu 'alalloh, wala haula wala quwata illa billah",
    "arti":
  ...
  },
  {
    ...
    "arab":
        "اَللَّهُمَّ إِنِّيْ أَعُوْذُ بِكَ أَنْ أَضِلَّ، أَوْ أُزِلَّ، أَوْ أُزَلَّ، أَوْ أُظْلَمُ، أَوْ أَجْهَلَ، أَوْ يُجْهَلَ عَلَيَّ",
    "latin":
        "Allohumma inni a'udzubika an adilla au'adholla, au azilla, au azalla, au adzlima, au adzlama, au aj'hala, au yuj'hala alaiya",
    "arti":
        "Ya Allah, sesungguhnya aku berlindung kepada-Mu, jangan sampai aku sesat atau disesatkan (setan atau orang yang berwatak setan), atau berbuat kesalahan atau disalahi, menganiaya atau dianiaya (orang), dan berbuat bodoh atau dibodohi",
    "footnote":
        "HR. Seluruh penyusun kitab Sunan, dan lihath Shahih At-Tirmidzi: 3/152 dan Shahih Ibnu Majah: 2/336"
  },
  {
    "tag": ['rumah', 'bismillah', 'bismilah', 'basmalah'],
    "judul": "Do'a Masuk Rumah",
    "arab":
        "بِسْمِ اللّٰهِ وَلَجْنَا، وَبِسْمِ اللّٰهِ خَرَجْنَا، وَعَلَى رَبِّنَا تَوَكَّلْنَا ثُمَّ لِيُسَلِّمْ عَلَى أَهْلِهِ",
    "latin":
        "Bismillahi walaj'na wabismillahi khoroj'na wa'ala robbina yatawakkaluna",
    "arti":
